class NumMatrix:
    ...
    def update(self, row: int, col: int, val: int) -> None:
        ...
        # print("n", self.matrix[row][col])
        # print(self.prefix_sum_row[row][col])
        # print(self.prefix_sum_col[col][row])
    ...
    def sumRegion(self, row1: int, col1: int, row2: int, col2: int) -> int:
        ...
        #     print(self.matrix[r])
        # print("=====")
        # print("n", self.matrix[3][2])
        # print(self.prefix_sum_row[3][2])
        # print(self.prefix_sum_col[2][3])
        total = 0
